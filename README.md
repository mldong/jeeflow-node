...
[jeeflow](https://github.com/mldong/jeeflow-spec) 引擎规范的 **TypeScript 实现**。仅依赖 `node:*` 标准库，零外部依赖（引擎核心）。
...
对齐 [SPEC.md](https://github.com/mldong/jeeflow-spec) v1.0——与 Java/Go 版一致。
