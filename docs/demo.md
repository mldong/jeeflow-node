...
> 演示站是运行在 :8082 的 Express 应用（内存仓储 + 10 个示例流程），对接 jeeflow-ui 体验完整流程。SDK 集成（SPI）见 [引擎 API](./engine-api.md) / [SPI 实现指南](./spi-guide.md)。
...
> 演示站从 `jeeflow-java` 的共享流程 JSON 加载 10 个示例流程。对接 jeeflow-ui（:5173）时右上角切到 `🟢 Node :8082`；接口规范见[统一门面接口文档](../../spec/06-facade)。
